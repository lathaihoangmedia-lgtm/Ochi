...
Tài liệu này chốt lại quyết định **dùng Ochi làm brand nhất quán** cho toàn bộ hoạt động phát triển trong repository này.
...
- Không xóa bỏ logic nền tảng OpenFang nếu chưa có phương án tương thích ngược rõ ràng.

## 2) Repo tham chiếu chính thức

- Ophiuchus agent reference: `https://github.com/lathaihoangmedia-lgtm/Ophiuchus--agent`
- OpenFang upstream reference: `https://github.com/RightNow-AI/openfang`
...
- Ánh xạ capability theo nhóm để tái sử dụng cơ chế policy, RBAC, audit log từ nền OpenFang.

## 5) Tiêu chí “brand nhất quán”

- Tài liệu public-facing ưu tiên tên **Ochi**.
- Khi nhắc tới OpenFang, dùng ngữ cảnh “nền tảng kế thừa/upstream”.
- Tránh đổi tên crate hoặc đường dẫn lõi một cách ồ ạt trong giai đoạn đầu để giảm rủi ro kỹ thuật.
