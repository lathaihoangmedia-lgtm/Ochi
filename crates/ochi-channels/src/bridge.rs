...
///
/// Defined here to avoid circular deps (ochi-channels can't depend on ochi-kernel).
/// Implemented in ochi-api on the actual kernel.
#[async_trait]
...
async fn dispatch_message(
    ...
    let agent_id = router.resolve(
        ...
        message.sender.ochi_user.as_deref(),
    );
