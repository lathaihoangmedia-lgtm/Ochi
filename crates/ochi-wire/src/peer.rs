//! PeerNode — TCP server and client for the Ochi Wire Protocol.
//!
//! A [`PeerNode`] binds a local TCP listener and accepts incoming connections
//! from other Ochi kernels. It also connects outward to known peers. Each
...
mod tests {
    ...
    fn test_peer_config_default() {
        ...
        assert_eq!(config.node_name, "ochi-node");
